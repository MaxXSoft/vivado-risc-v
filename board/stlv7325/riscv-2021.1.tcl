...
# module references:
# $rocket_module_name, mem_reset_control, ethernet, sdc_controller, uart, ethernet_stlv7325
...
proc create_hier_cell_IO { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type rst eth_mdio_reset
  ...
  set block_name ethernet_stlv7325
...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  connect_bd_net -net mem_areset [get_bd_pins mem_reset_control_0/aresetn] [get_bd_pins mig_7series_0/aresetn]
  ...
  connect_bd_net -net reset_h [get_bd_pins sys_reset] [get_bd_pins mem_reset_control_0/sys_reset]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set eth_mdio_clock [ create_bd_port -dir O -type clk eth_mdio_clock ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {2500000} \
 ] $eth_mdio_clock
  set eth_mdio_data [ create_bd_port -dir IO eth_mdio_data ]
  set eth_mdio_reset [ create_bd_port -dir O -type rst eth_mdio_reset ]
